package com.yeahwell.acm.sword.linkedlist;

/**
 * <a href="http://blog.csdn.net/derrantcm/article/details/46721767">http://blog.csdn.net/derrantcm/article/details/46721767</a>
 * <h5>【面试题26：复杂链表的复制】</h5>
 * 题目：请实现函数ComplexListNode clone(ComplexListNode head),复制一个复杂链表。
 * 在复杂链表中，每个结点除了有一个next域指向下一个结点外，还有一个sibling指向链表中的任意结点或者null。
 * @author yeahwell
 *
 */
public class Test26 {
