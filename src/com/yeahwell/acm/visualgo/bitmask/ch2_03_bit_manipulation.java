package com.yeahwell.acm.visualgo.bitmask;

import java.util.Stack;

public class ch2_03_bit_manipulation {
	...
	private static int nearestPowerOfTwo(int S) {
		return ((int) Math.pow(2.0,
				(int) ((Math.log((double) S) / Math.log(2.0)) + 0.5)));
	}
	...
	private static void printSet(int vS){
